namespace System.Windows.Forms
{
	internal static class ControlExtension
	{
		...
		public static string GetMessageString(this Control ctrl, uint getLenMsg, uint getTextMsg)
		{
			if (ctrl.IsHandleCreated)
			{
				int cp = Microsoft.Win32.NativeMethods.SendMessage(ctrl.Handle, getLenMsg).ToInt32() + 1;
				System.Text.StringBuilder sb = new System.Text.StringBuilder(cp);
				Microsoft.Win32.NativeMethods.SendMessage(ctrl.Handle, getTextMsg, ref cp, sb);
				return sb.ToString();
			}
			return null;
		}
		...
		public static void SetStyle(this Control ctrl, int style, bool on = true)
		{
			...
			int oldstyle = Microsoft.Win32.NativeMethods.GetWindowLong(ctrl.Handle, GWL_STYLE).ToInt32();
			if ((oldstyle & style) != style && on)
				Microsoft.Win32.NativeMethods.SetWindowLong(ctrl.Handle, GWL_STYLE, new IntPtr(oldstyle | style));
